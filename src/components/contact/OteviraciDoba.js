	...
	return(
      ...
      <div className="dt dt--fixed ">
          <div className="dtc tc pv0 pl3">
            <p className="fw7 f5-ns f6 red ma2">pondělí 20.12.</p>
          </div>
      ...
      <div className="dt dt--fixed ">
          <div className="dtc tc pv0 pl3">
            <p className="fw7 f5-ns f6 red ma2 ">úterý 20.12.</p>
          </div>
          <div className="dtc tc pv0 pr2">
            <p className="fw7 f5-ns f6 red ma2">Otevřeno</p>
          </div>
      ...
      <div className="dt dt--fixed ">
          <div className="dtc tc pv0 pl3">
            <p className="fw7 f5-ns f6 red ma2">22.12. - 27.12.</p>
          </div>
          <div className="dtc tc pv0 pr2">
      ...
      <div className="dt dt--fixed ">
          <div className="dtc tc pv0 pl3">
            <p className="fw7 f5-ns f6 red ma2">úterý 28.12.</p>
          </div>
          <div className="dtc tc pv0 pr2">
            <p className="fw7 f5-ns f6 red ma2">Otevřeno</p>
          </div>
      ...
      <div className="dt dt--fixed ">
          <div className="dtc tc pv0 pl3">
            <p className="fw7 f5-ns f6 red ma2">středa 29.12.</p>
          </div>
          <div className="dtc tc pv0 pr2">
            <p className="fw7 f5-ns f6 red ma2">Otevřeno</p>
          </div>
      ...
      <div className="dt dt--fixed ">
          <div className="dtc tc pv0 pl3">
            <p className="fw7 f5-ns f6 red ma2">30.12.-2.1.</p>
          </div>
          <div className="dtc tc pv0 pr2">
            <p className="fw7 f5-ns f6 red ma2">Zavřeno</p>
          </div>
